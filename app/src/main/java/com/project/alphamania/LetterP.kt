...
class LetterP : AppCompatActivity(), TextToSpeech.OnInitListener {

    private lateinit var tts: TextToSpeech
    private var pigSound: MediaPlayer? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pigSound = MediaPlayer.create(this, R.raw.sound_p)

        val pigImage = findViewById<ImageView>(R.id.pigImage)
